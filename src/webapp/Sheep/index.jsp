...
<symbol id="icon-desktop" viewBox="0 0 24 17">
  ...
  <header class="header">
    ...
    <div class="header__updated"><em>sheep</em> updated 12.05.2017, 1 pages</div>
    <nav class="types">
  ...
  <section>
    <ol class="pagelist">
          ...
          <li  class="is-notready" >

                <a class="pagelist__title  is-active " target="_blank" href="page.jsp"><span>1.</span><em>page</em></a>
                <a href="page.jsp" class="pagelist__url">
  ...
  <aside class="preview" id="preview-wrapper">
    ...
    <iframe id="preview" width="1600" height="600" src="page.jsp" frameborder="0"></iframe>
    <footer>
